...
```{r}
aprioriLoc <- paste(realWd,'r_code','aprioriVars.R',sep='/')
...
```{r}
jk <- grabFunc(aprioriLoc,'1.8 * ',returnFun=0,shouldCat=1, atStart=0)
```
...
iterateLoc <- paste(realWd,'r_code','iterateHYSPLIT.R',sep='/')
