...
####Figure `r figList$flightDur`. The distribution of the length of flight with respect to the latitudes and the day of the year. The solid line refers to `r ys[1]` latitude (Middle of Mexico), the dotted line refers to `r ys[gridLen/2]` latitude () and the dashed line refers to  `r ys[gridLen]` latitude (CA-US border)
